...
(def uri (if production? "datomic:free://localhost:4334" "datomic:mem://forum5"))
  ...
  (let [interval (org.joda.time.Interval. date1 date2)]
    (q {:find '[?bid]
        ...
        :where '[[?id :beitrag/id ?bid]
                 ...
                 [(forum.db/within ?interval ?datum)]]} db interval)))
